...
<body>
  <div class="wrapper">
    <div class="container-fluid">
      <div class="content">
        <div class="jumbotron">
          <h1>Micro Controller IOT </h1>
          <h5>NodeMCU ESP8226</h3>
        </div>
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-6">
      ...
      <div class="container-fluid footer justify-content-center align-items-center" style="border-radius: 5px;">
